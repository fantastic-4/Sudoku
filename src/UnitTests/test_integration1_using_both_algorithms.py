...
#        self.iofile_hard=IO_File("To_read_sudoku_hard.txt")
    ...
    def test_resolve_string_from_file_using_norvig_easy(self):
        ...
        start = time.clock()
        other_grid=self.norvig.solve(val)
        t = time.clock()-start
        #print "The grid given to solve by Norvig is:\n\n", val
        self.grid.raw_grid=val
        self.grid.var_name='sudoku_resolver_norvig_easy'
        time_show= ' %.3f seconds' % t
        #print "The grid solved in "+time_show+ " is:\n\n "
        self.grid.time_show=time_show
        #self.grid.display(other_grid)
        self.assertEqual(self.grid_expected,other_grid)

#     def test_resolve_string_from_file_using_brute_easy(self):
#         val1=self.iofile_easy.input_file('========')
#         start = time.clock()
#         other_grid1=self.brute.solve(val1)
#         t = time.clock()-start
#         #print "The grid given to solve by Brute is:\n\n", val1
#         self.grid.raw_grid=val1
#         self.grid.var_name='sudoku_resolver_brute_easy'
#         time_show= '%.3f seconds' % t
#         #print "The grid solved in "+time_show+ " is:\n\n "
#         self.grid.time_show=time_show
#         #self.grid.display(other_grid1)
#         self.assertEqual(self.grid_expected,other_grid1)

#     def test_resolve_string_from_file_using_norvig_hard(self):
#         val=self.iofile_hard.input_file('========')
#         start = time.clock()
#         other_grid=self.norvig.solve(val)
#         t = time.clock()-start
#         #print "The grid given to solve by Norvig (Hard) is:\n\n", val
#         self.grid.raw_grid=val
#         #self.grid.var_name='sudoku_resolver_norvig_Hard'
#         time_show= '%.3f seconds' % t
#         #print "The grid solved in "+time_show+ " is:\n\n "
#         self.grid.time_show=time_show
#         self.grid.display(other_grid)
...
#        val1=self.iofile_hard.input_file('========')
#        start = time.clock()
#        other_grid1=self.brute.solve(val1)
#        t = time.clock()-start
#        print "The grid given to solve by Brute (hard) is:\n\n", val1
#        self.grid.raw_grid=val1
#        self.grid.var_name='sudoku_resolver_brute_hard'
#        time_show= ' %.3f seconds' % t
#        print "The grid solved in"+time_show+ " is:\n\n "
#        self.grid.time_show=time_show
#        self.grid.display(other_grid1)
#        self.assertEqual(self.expected_grid_hard,other_grid1)
